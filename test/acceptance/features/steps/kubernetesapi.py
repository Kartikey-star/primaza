...
@step(u'On Primaza Cluster "{cluster}", ServiceCatalog "{catalog_name}" does not contain RegisteredService "{rs_name}"')
...
@step(u'On Worker Cluster "{cluster}", ServiceCatalog "{catalog_name}" in application namespace "{namespace}" does not contain RegisteredService "{rs_name}"')
